...
void esp8266_uart_send(USART_TypeDef *USARTx,  char *str, unsigned short len)
{

    HAL_UART_Transmit(&g_uart_handle, (uint8_t *)str, len, HAL_MAX_DELAY);
}
...
{
//if(__HAL_UART_GET_FLAG(&g_uart_handle, UART_FLAG_ORE) != RESET) //接收中断
//{
